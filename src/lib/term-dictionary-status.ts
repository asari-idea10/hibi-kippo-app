...
export const termDictionaryStatusRows: TermDictionaryStatusRow[] = [
  ...
  },
  {
    id: "sanmeigaku",
    category: "算命学",
    routeLabel: "算命学 / 陽占 人体星図",
    routeExample: "/calendar-notes/sanmeigaku/陽占 人体星図",
    calendarLinkStatus: "接続済み",
    masterStatus: "陽占 人体星図・十大主星・十二大従星の詳細ページへ接続済み",
    implementationStatus: "正式採用",
    verificationStatus: "サンプル確認済み",
    textStatus: "本文あり",
    textQualityStage: "読める本文",
    editorialPriority: "高",
    seoArticleStatus: "未着手",
    articleSeed: "陽占人体星図、十大主星、十二大従星の見方と学習導線",
    source: "算命学星名マスター / 算命計算シート説明マスター",
    nextAction: "身弱・身中・身強の辞典化は意味説明マスター確認後に別タスクで判断",
  },
  {
